...
export default function MemberLoginPage() {
  ...
  const MEMBERS = [
    { name: "Fahad", email: "fahad@argplatform.com" },
    { name: "Ajiya", email: "ajiya@argplatform.com" },
    { name: "Hiba", email: "hiba@argplatform.com" },
    { name: "Kinjal", email: "kinjal@argplatform.com" },
    { name: "Khizra", email: "khizra@argplatform.com" },
  ];
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/70 border border-slate-200/80 p-7 sm:p-9">
          ...
          <div className="text-center mb-6">
            ...
            <div className="mt-4 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-200/70 text-emerald-800 text-xs font-bold">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-xs sm:text-sm text-slate-500 mt-1">
              Sign in to view your assigned tasks and submit updates.
            </p>
          </div>

          {/* Login Form */}
          <form onSubmit={handleLogin} className="space-y-4">
            {/* Member Quick Selector Chips */}
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="fahad@argplatform.com"
                  autoComplete="email"
